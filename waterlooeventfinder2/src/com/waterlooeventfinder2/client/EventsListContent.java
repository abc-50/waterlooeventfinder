...
public class EventsListContent extends Content {
	...
	public EventsListContent() {
		...
		categoryBox.addChangeHandler(new ChangeHandler() {
			...
			public void onChange(ChangeEvent event) {
				...
				GetEventsByFilter(ldp, categoryBox.getSelectedIndex(), timeBox.getSelectedIndex());
	...
	private void GetEventsByFilter(final ListDataProvider<Event> ldp, int catFilter, int timeFilter) {
		if (retrievalService == null) {
			retrievalService = GWT.create(EventRetrievalService.class);
		}
